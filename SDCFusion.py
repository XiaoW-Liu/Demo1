...
class SDCFusion(nn.Module):
    ...
    def cross_modal_fusion(self, rgb1, rgb2, rgb3, rgb4, thermal1, thermal2, thermal3, thermal4):
        ...
        sem1, sem1_RGB, sem1_INF, sem1_RGB_INF, sem1_INF_RGB = self.GEFM1(rgb1, thermal1)
        sem2, sem2_RGB, sem2_INF, sem2_RGB_INF, sem2_INF_RGB = self.GEFM2(rgb2, thermal2)
        sem3, sem3_RGB, sem3_INF, sem3_RGB_INF, sem3_INF_RGB = self.GEFM3(rgb3, thermal3)
        sem4, sem4_RGB, sem4_INF, sem4_RGB_INF, sem4_INF_RGB = self.GEFM4(rgb4, thermal4)
    ...
    def forward(self, rgb, depth):
        ...
        return fused_img, semantic_out, fu_semantic_out
...
class CDIM(nn.Module):
    ...
    def forward(self, x, y):
        ...
        return out, RGB_refine_view, INF_refine_view, RGB_INF_refine_view, INF_RGB_refine_view
