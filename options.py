...
class TrainOptions():
  def __init__(self):
    ...
    # training related
    self.parser.add_argument('--lr', default=1e-2, type=int, help='Initial learning rate for training model')
    self.parser.add_argument('--weight', default='dwa', type=str, help='multi-task weighting: equal, uncert, dwa')
    self.parser.add_argument('--n_ep', type=int, default=50000, help='number of epochs') # 400 * d_iter
