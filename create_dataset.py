...
class MSRSData(torch.utils.data.Dataset):
    ...
    def __init__(self, opts, is_train=True, crop=lambda x: x):
        ...
        if is_train:
            self.vis_folder = os.path.join(opts.dataroot, opts.dataname, 'train', 'vi')
            self.ir_folder = os.path.join(opts.dataroot, opts.dataname, 'train', 'ir')
            self.label_folder = os.path.join(opts.dataroot, opts.dataname, 'train', 'label')
        else:
            ...
            self.label_folder = os.path.join(opts.dataroot, opts.dataname,'test', 'label')  
